...
if __name__ == '__main__':
    ...
    # 强制将 date 列作为字符串读取，完美避开 int64 和 str 的比对报错
    data = pd.read_csv(file, names=columns, dtype={'date': str}, low_memory=False)
        
    # 触发底层脚本，计算物理转移概率并动态生成 .pcsp 模板文件
    generate_transition_probs(data, date, ply1_name, ply2_name, "RH", "RH")